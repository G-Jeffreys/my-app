...
export default function SettingsScreen() {
  ...
  // Check if user has an auto-generated display name
  const isAutoGeneratedName = user?.displayName && (
    user.displayName.startsWith('User') || 
    user.displayName === '' ||
    user.displayName.match(/^[A-Z][a-z]+ [A-Z][a-z]+$/) // Likely auto-generated from email
  );
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.fieldContainer}>
            ...
            {isAutoGeneratedName && (
              <View style={styles.autoNameNotice}>
                <Text style={styles.autoNameNoticeText}>
                  💡 We generated this name from your email. Feel free to customize it!
                </Text>
              </View>
            )}
            <TextInput
